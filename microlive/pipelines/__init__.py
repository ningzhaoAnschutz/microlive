...
Available pipelines:
    ...
    - pipeline_FISH: Multi-cell spot detection and
      quantification for fixed-cell datasets (TIFF, LIF, CZI, or folder)
...
#   from microlive.pipelines.pipeline_FISH import pipeline_multicell_spot_detection
